...
public:
  singleOutputRedirect() //Default Constructor
	: type(">"), executed(false), exec(true)
	{}
  singleOutputRedirect(RShell* l) //Single RShell Constructor
  : left(l), type(">"), executed(false), exec(true)
  {}
  singleOutputRedirect(RShell* l, RShell* r) //Double RShell Constructor
